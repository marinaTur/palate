...
17. **Palette v1.1's 19 hardcoded hex literals — a judgment task deliberately deferred out of the mechanical rollout, brief below.**

### Brief: fix the 19 hardcoded hex literals left by Palette v1.1's rollout
...
- `Home.jsx:154` — `'#264D3B' : '#E2DDD6'` (progress dot, ternary) — almost certainly should become `var(--forest)` / `var(--border)`.
